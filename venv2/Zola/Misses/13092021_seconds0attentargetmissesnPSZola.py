...
for i in range(100, 186):
    ...
    user_input = 'D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/nopitchshiftTarget/orderingbyLRtime/completemiss2s'
...
BASE_PATH='D:/Electrophysiological_Data/F1702_Zola_Nellie/dynamictimewarping/nPScompletemiss'
