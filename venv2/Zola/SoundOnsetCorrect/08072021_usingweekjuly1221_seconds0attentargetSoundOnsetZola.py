...
fig.suptitle('Original Data Reorganised by Lick Release, Aligned to Sound Onset week 12/07/2021, Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, epoch_offset, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (CORRECT releases  12/07/2021 Zola) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (CORRECT releases  12/07/2021 Zola) ', fontsize=10, color='0', y='1')
...
fig2, axes2= psth_plots(cropped_data2, sorted_array, NBINS, TMIN, TMAX, combinedTrials, 'purple', epoch_offset, subplots=(5, 8),style='white');
