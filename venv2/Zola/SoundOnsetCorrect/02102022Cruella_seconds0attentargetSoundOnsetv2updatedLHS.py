...
NBINS = int((TMAX - TMIN) / BINSIZE)
TMINz=0.2*1000;
TMAXz =0.39*1000#max(combinedLickReleaseTimes) # s
...
fig.suptitle('Original Data (all lick releases 07/02/2022 Cruella BB4 BB5 RIGHT) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Reorganised by Lick Release, Aligned to Sound Onset 07/02/2022, Cruella  BB4 BB5 RIGHT) ', fontsize=10, color='0', y='1')
