...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1902_Eclair/HP_BlockNellie-'+str(i)+'/targetword/soundOnset/orderingbyLRtime/withmisses2sBB4BB5'
...
fig.suptitle('Original Data (all lick releases 07/02/2022 Eclair BB2 BB3 RIGHT) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Reorganised by Lick Release, Aligned to Sound Onset 07/02/2022, Eclair BB2 BB3 RIGHT) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (CORRECT releases  07/02/2022 Eclair) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (CORRECT releases  07/02/2022 Eclair) ', fontsize=10, color='0', y='1')
