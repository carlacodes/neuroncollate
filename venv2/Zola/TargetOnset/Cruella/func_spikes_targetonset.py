...
def disgustingly_long_func2(pitch_shift_or_not, left_hand_or_right, blocksOfInterest, fid):
    import numpy as np
    import matplotlib.pyplot as plt
    from affinewarp import ShiftWarping
    import os
    ...
    for k00 in pitch_shift_or_not:
        ...
        for k0 in left_hand_or_right:
            ...
            fig.suptitle('Original Data (all lick releases 04-11/04/2022 Cruella LEFT)'+fid + k0, fontsize=10, color='0',
                         y='1')
            ...
            fig.suptitle(
                'Original Data Reorganised by Lick Release, Aligned to Target Word Onset'+fid + k0,
                fontsize=10, color='0', y='1')

            plt.show()  # original data

            fig, axes = rasters(shift_aligned_data, sorted_array, epoch_offset, subplots=(5, 8), style='white');
            fig.suptitle(' Rasters after Shift Model (CORRECT releases)'+fid + k0, fontsize=10,
                         color='0', y='1')
            ...
            fig.suptitle(' Rasters after Linear Model (CORRECT releases) ' +fid+ k0, fontsize=10,
                         color='0', y='1')
            ...
            fig.suptitle(' Rasters after Linear Model (ordered by LR onset)'+fid + k0, fontsize=10,
                         color='0', y='1')

            fig, axes = psth_plots(cropped_data2, sorted_array, NBINS, TMIN, TMAX, combinedTrials, 'blue', epoch_offset,
                                   subplots=(5, 8), style='white');
            fig.suptitle(' PSTHS relative to target word onset' + fid+ k0, fontsize=10, color='0', y='1')
