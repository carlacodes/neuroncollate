...
f={}
blockData={}
blocksOfInterest=[134, 135,136, 137,139,140,141,142,143]
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/pitchshiftTarget13/orderingbyLRtime/Correct15092s'
...
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/PitchShiftTarget13'
...
np.save(os.path.join(BASE_PATH, 'june0721neuronIDsPS'), shift_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'june0721trialIDsPS'), shift_aligned_data["trials"])
...
np.save(os.path.join(BASE_PATH, 'june0721linearModelneuronIDsPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'june0721linearModeltrialIDsPS'), linear_aligned_data["trials"])

file_name='alignedDataBlockweekjune072021OriginalModellickrelease'
