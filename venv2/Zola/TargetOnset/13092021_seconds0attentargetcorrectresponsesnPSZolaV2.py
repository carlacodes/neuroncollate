...
#
#     user_input = 'D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i0)+'/targetword/nopitchshiftTarget/orderingbyLRtime/Correct28042s'
#     if os.path.isdir(user_input) is False:
#         print('does not exist')
#         blocksOfInterest.remove(i0)


blocksOfInterest = [num for num in blocksOfInterest0 if os.path.isdir('D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(num)+'/targetword/nopitchshiftTarget/orderingbyLRtime/Correct28042s') is True ]

for i in blocksOfInterest:

    user_input = 'D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/nopitchshiftTarget/orderingbyLRtime/Correct28042s'
    # if os.path.isdir(user_input) is False:
    #     print('does not exist')
...
BASE_PATH='D:/Electrophysiological_Data/F1702_Zola_Nellie/dynamictimewarping/nPSbatchnomiss0105'
