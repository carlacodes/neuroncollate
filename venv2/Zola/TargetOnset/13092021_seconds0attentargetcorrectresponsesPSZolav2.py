...
f={}
blockData={}
blocksOfInterest0=list(range(100, 186))
blocksOfInterest2=[]
itemstoremove=[]
# for i0 in range(100, 186):
# #targetword\nopitchshiftTarget\orderingbyLRtime\Correct28042s
#     user_input = 'D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i0)+'/targetword/pitchshiftTarget/orderingbyLRtime/Correct28042s'
#
#     if os.path.isdir(user_input) is False:
#         print('does not exist')
#     else:
#         blocksOfInterest2=np.append(blocksOfInterest2, i0)
# blocksOfInterest=blocksOfInterest2.tolist()
# blocksOfInterest=(list(map(int, blocksOfInterest)))
blocksOfInterest = [num for num in blocksOfInterest0 if os.path.isdir('D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(num)+'/targetword/pitchshiftTarget/orderingbyLRtime/Correct28042s') is True ]

for i in blocksOfInterest:
#targetword\nopitchshiftTarget\orderingbyLRtime\Correct28042s
    user_input = 'D:/Electrophysiological_Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/pitchshiftTarget/orderingbyLRtime/Correct28042s'
...
fig.suptitle('Original Data Reorganised (Correct Intra-Trial F0 Roved Target Responses May-July 2021 Zola) ', fontsize=10, color='0', y='1')
...
BASE_PATH='D:/Electrophysiological_Data/F1702_Zola_Nellie/dynamictimewarping/PSbatchnomiss0105'
...
np.save(os.path.join(BASE_PATH, 'mayjuly21trialIDsPS'), shift_aligned_data["trials"])
...
np.save(os.path.join(BASE_PATH, 'mayjuly21linearModelneuronIDsPS'), linear_aligned_data["neurons"])
