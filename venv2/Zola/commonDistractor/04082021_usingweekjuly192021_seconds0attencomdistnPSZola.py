...
f={}
blockData={}
blocksOfInterest=[187,188,189,190,192,193,194,195]
...
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/comdistnoPitchShift/july192021'
#os.mkdir(BASE_PATH)
...
np.save(os.path.join(BASE_PATH, 'july19neuronIDsnPS'), shift_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july19trialIDsnPS'), shift_aligned_data["trials"])
...
np.save(os.path.join(BASE_PATH, 'july19linearModelneuronIDsnPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july19linearModeltrialIDsnPS'), linear_aligned_data["trials"])
...
np.save(os.path.join(BASE_PATH, 'july19OriginalModelneuronIDsnPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july19OriginalModeltrialIDsnPS'), linear_aligned_data["trials"])