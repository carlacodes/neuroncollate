...
f={}
blockData={}
blocksOfInterest=[177,180,181,182,183,184,185]
...
np.save(os.path.join(BASE_PATH, 'july21neuronIDsPS'), shift_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july21trialIDsPS'), shift_aligned_data["trials"])
...
np.save(os.path.join(BASE_PATH, 'july21linearModelneuronIDsPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july21linearModeltrialIDsPS'), linear_aligned_data["trials"])

file_name='alignedDataBlockweekjuly212021OriginalModellickrelease'
np.save(os.path.join(BASE_PATH, file_name), cropped_data2["spiketimes"])
np.save(os.path.join(BASE_PATH, 'july21OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'july21OriginalModeltrialIDsPS'), cropped_data2["trials"])