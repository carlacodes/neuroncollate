...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1902_Eclair/HP_BlockNellie-'+str(i)+'/distF2/orderingbyLRtime/nopitchshift2sBB4BB5'
...
fig.suptitle('Original Data (all lick releases 07/02/2022 Aligned to Distractor Word Onset craft Eclair bb4bb5 LEFT) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Reorganised by Lick Release, Aligned to Distractor Word Onset CRAFT 07/02/2022, Eclair BB4 BB5 LEFT) ', fontsize=10, color='0', y='1')
