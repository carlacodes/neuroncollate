...
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/comdistPitchShift/may102021'
#os.mkdir(BASE_PATH)
...
np.save(os.path.join(BASE_PATH, 'may10OriginalModelneuronIDsPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'may10OriginalModeltrialIDsPS'), linear_aligned_data["trials"])
