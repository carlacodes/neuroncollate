...
np.save(os.path.join(BASE_PATH, 'july19OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'july19OriginalModeltrialIDsPS'), cropped_data2["trials"])