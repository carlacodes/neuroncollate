...
np.save(os.path.join(BASE_PATH, 'june21OriginalModelneuronIDsnPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june21OriginalModeltrialIDsnPS'), cropped_data2["trials"])