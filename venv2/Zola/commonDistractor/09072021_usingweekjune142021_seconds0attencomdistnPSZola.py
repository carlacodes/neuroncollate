...
np.save(os.path.join(BASE_PATH, 'june14OriginalModelneuronIDsnPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june14OriginalModeltrialIDsnPS'), cropped_data2["trials"])