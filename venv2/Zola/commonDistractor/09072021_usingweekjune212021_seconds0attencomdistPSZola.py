...
np.save(os.path.join(BASE_PATH, 'june21OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june21OriginalModeltrialIDsPS'), cropped_data2["trials"])