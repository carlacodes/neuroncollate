...
np.save(os.path.join(BASE_PATH, 'june07OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june07OriginalModeltrialIDsPS'), cropped_data2["trials"])