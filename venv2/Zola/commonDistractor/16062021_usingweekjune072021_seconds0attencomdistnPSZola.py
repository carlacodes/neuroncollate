...
np.save(os.path.join(BASE_PATH, 'june07OriginalModelneuronIDsnPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june07OriginalModeltrialIDsnPS'), cropped_data2["trials"])