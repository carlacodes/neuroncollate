...
np.save(os.path.join(BASE_PATH, 'june14OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'june14OriginalModeltrialIDsPS'),  cropped_data2["trials"])