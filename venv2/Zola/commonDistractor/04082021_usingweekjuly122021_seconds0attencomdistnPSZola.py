...
np.save(os.path.join(BASE_PATH, 'july12OriginalModelneuronIDsnPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'july12OriginalModeltrialIDsnPS'), linear_aligned_data["trials"])