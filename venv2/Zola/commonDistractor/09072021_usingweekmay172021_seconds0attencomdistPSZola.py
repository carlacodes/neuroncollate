...
fig.suptitle('Original Data (all lick releases 17/05/2021 Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Aligned to Distractor Onset, Organised by Relative Lick Release Time (CORRECT PITCH SHIFT lick releases 17/05/2021 Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (CORRECT PITCH SHIFT lick releases  17/05/2021 Zola) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (CORRECT PITCH SHIFT lick releases week 17/05/21 Zola) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (ordered by LR onset week 17/05/21 Zola) ', fontsize=10, color='0', y='1')
...
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/comdistPitchShift/may172021'
#os.mkdir(BASE_PATH)
...
np.save(os.path.join(BASE_PATH, 'may17OriginalModelneuronIDsPS'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'may17OriginalModeltrialIDsPS'), linear_aligned_data["trials"])