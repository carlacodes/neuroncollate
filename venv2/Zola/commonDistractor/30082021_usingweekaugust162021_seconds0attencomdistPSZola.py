...
f={}
blockData={}
blocksOfInterest=[209,210,211,212]
...
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/comdistPitchShift/august162021'
#os.mkdir(BASE_PATH)
file_name='alignedDataBlockweekaugust162021ShiftModellickreleaseDist'
...
file_name='alignedDataBlockweekaugust162021LinearModellickreleaseDist'
...
file_name='alignedDataBlockweekaugust162021OriginalModellickreleaseDist'
np.save(os.path.join(BASE_PATH, file_name), cropped_data2["spiketimes"])
np.save(os.path.join(BASE_PATH, 'august16OriginalModelneuronIDsPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'august16OriginalModeltrialIDsPS'), cropped_data2["trials"])