...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/nopitchshiftTarget/orderingbyLRtime'
...
fig, axes= rasters(linear_aligned_dataLR, subplots=(5, 8),style='white');
