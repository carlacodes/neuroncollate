...
import h5py
import numpy as np
filepath = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/commondistractor20/noPitchShift/spikeArraysBlockNellie-111BB2andBB3curratten0dist20May-20-2021-11-30-27-645-AM.mat'
arrays = {}
...
data2=SpikeData(
    trials=arrays["oneDtrialIDarray"], #arrays["oneDtrialIDarray"],
    spiketimes=arrays["oneDspiketimearray"], #["oneDspiketimearray"],
    neurons=arrays["oneDspikeIDarray"], #["oneDspikeIDarray"],
    tmin=TMIN,
    tmax=TMAX,
)
...
file_name='alignedDataBlock111ShiftModeldistractor20nPS'
...
file_name='alignedDataBlock111LinearModeldistractor20nPS'
np.save(os.path.join(BASE_PATH, file_name), shift_aligned_data["spiketimes"])
