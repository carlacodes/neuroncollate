...
f={}
blockData={}
blocksOfInterest=[197,198,199,200,201,203]
...
fig.suptitle('Original Data (nPS 17-24/05/2021 FloJo) ', fontsize=10, color='1', y='1')

#plt.title('Rasters of Original Data (18/03/2021 Zola) ')
plt.show() #original data

fig, axes=rasters(shift_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Shift Model (nPS 17-24/05/2021 FloJo) ', fontsize=10, color='1', y='1')

#plt.title('Rasters after Shift Model (18/03/2021 Zola) ')
plt.show()

fig, axes= rasters(linear_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Linear Model (nPS TARGET WORD 17-24/05/2021 FloJo) ', fontsize=10, color='1', y='1')
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1704_FloJo/dynamictimewarping/targetword'
file_name='alignedDataBlockweekmay172021ShiftModeldistractorAccurate'
...
file_name='alignedDataBlockweekmay172021LinearModeldistractorAccurate'
