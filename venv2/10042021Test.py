...
mat_fname = pjoin(data_dir, 'spikesBlockNellie-68BB2andBB3April-18-2021.h5')

#import scipy.optimize.nnls
#matplotlib inline
mat_contents =  h5py.File(mat_fname)
data1 = mat_contents.get('HP_BlockNellie-682').value
data2=data1.transpose()

data2 = data2[..., np.newaxis]
list(mat_contents.keys())
struArray = mat_contents['HP_BlockNellie-682']
