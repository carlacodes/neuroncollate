...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1704_FloJo/HP_BlockNellie-'+str(i)+'/targetword'
...
fig.suptitle('Original Data (nPS 31-04/06/2021 FloJo) ', fontsize=10, color='1', y='1')

#plt.title('Rasters of Original Data (18/03/2021 Zola) ')
plt.show() #original data

fig, axes=rasters(shift_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Shift Model (nPS 31-04/06/2021 FloJo) ', fontsize=10, color='1', y='1')

#plt.title('Rasters after Shift Model (18/03/2021 Zola) ')
plt.show()

fig, axes= rasters(linear_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Linear Model (nPS TARGET WORD 31-04/06/2021 FloJo) ', fontsize=10, color='1', y='1')
...
file_name='alignedDataBlockweekmay242021ShiftModeldistractorAccurate'
...
file_name='alignedDataBlockweekmay242021LinearModeldistractorAccurate'
