...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1704_FloJo/HP_BlockNellie-'+str(i)+'/comdist20'
...
fig.suptitle(' Rasters after Linear Model (nPS 17-24/05/2021 FloJo) ', fontsize=10, color='1', y='1')
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1704_FloJo/dynamictimewarping/commondist20'
