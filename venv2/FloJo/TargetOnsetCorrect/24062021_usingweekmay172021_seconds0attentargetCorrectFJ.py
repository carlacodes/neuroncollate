...
fig.suptitle('Original Data (all lick releases 17/05/2021 FloJo) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Reorganised (CORRECT releases 17/05/2021 FloJo) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (CORRECT releases  17/05/2021 FloJo) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (CORRECT releases  17/05/2021 FloJo) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (ordered by LR onset 17/05/2021 FloJo) ', fontsize=10, color='0', y='1')
