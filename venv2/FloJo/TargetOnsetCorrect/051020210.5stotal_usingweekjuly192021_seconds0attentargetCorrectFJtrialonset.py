...
#objMat=[]
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1704_FloJo/LFP_BlockNellieL22/weekjuly192021//trialonset//LFP_Block'+str(i)
    directory = os.listdir(user_input)
...
plt.xticks(np.arange(math.floor(200), math.ceil(600), math.ceil(100)), np.arange(math.floor(0), math.ceil(600), math.ceil(100)))
...
f, t, Sxx =scipy.signal.spectrogram(testChan2, fs=1000)
