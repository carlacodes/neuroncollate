...
for i in range(187, 266):
    ...
    user_input = 'D:/Electrophysiological Data/F1704_FloJo/HP_BlockNellie-'+str(i)+'/targetword/orderingbyLRtime/Correct02102s'
...
BASE_PATH='D:/Electrophysiological Data/F1704_FloJo/dynamictimewarping/batchnomiss'
