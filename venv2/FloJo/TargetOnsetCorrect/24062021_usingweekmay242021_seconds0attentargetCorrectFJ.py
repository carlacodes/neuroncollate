...
f={}
blockData={}
#blocksOfInterest=[205, 206, 207, 208, 210,211,213]
blocksOfInterest=[204, 205, 206, 207, 208, 210,211,212,213]
...
fig, axes=rasters(cropped_data, sorted_array,(5, 8), style='black');
fig.suptitle('Original Data (all lick releases 24/05/2021 FloJo) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='black');
fig.suptitle('Original Data Reorganised (CORRECT releases 24/05/2021 FloJo) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (CORRECT releases  24/05/2021 FloJo) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (CORRECT releases  24/05/2021 FloJo) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (ordered by LR onset 24/05/2021 FloJo) ', fontsize=10, color='0', y='1')
...
BASE_PATH='D:/Electrophysiological Data/F1704_FloJo/dynamictimewarping/targetword/may242021'
...
file_name='alignedDataBlockweekmay242021OriginalModellickrelease'
np.save(os.path.join(BASE_PATH, file_name), cropped_data2["spiketimes"])
np.save(os.path.join(BASE_PATH, 'may24OriginalModelneuronIDsnPS'), cropped_data2["neurons"])
np.save(os.path.join(BASE_PATH, 'may24OriginalModeltrialIDsnPS'), cropped_data2["trials"])