...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/targetword/pitchshiftTarget/orderingbyLRtime/nomisses/lickRelease'
...
fig.suptitle('Original Data Reorganised (all lick releases07/06/2021 Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (all lick releases  07/06/2021 Zola) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (all lick releases  07/06/2021 Zola) ', fontsize=10, color='0', y='1')
