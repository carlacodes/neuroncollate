...
fp_deepinsight ='D:\Deepinsight Zola\DataBlockNellie-28.h5'  # This will be the processed HDF5 file
...
#
#
loss_functions = {'words' : 'euclidean_loss', 'timestamps' : 'mae'}
loss_weights = {'words' : 2, 'timestamps': 2}
