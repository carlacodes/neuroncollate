...
import h5py
import numpy as np
filepath = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/spikeArraysBlockNellie-111BB2andBB3atten0trialsMay-20-2021-11-11-35-985-AM.mat'
arrays = {}
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/'
file_name='alignedDataBlock111ShiftModel'
...
file_name2='alignedDataBlock111LinearModel'
np.save(os.path.join(BASE_PATH, file_name2), linear_aligned_data["spiketimes"])
np.save(os.path.join(BASE_PATH, 'linearModelneuronIDs'), linear_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'linearModeltrialIDs'), linear_aligned_data["trials"])
