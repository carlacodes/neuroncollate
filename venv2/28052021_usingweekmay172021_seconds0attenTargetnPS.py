...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/nopitchshiftTarget'
...
fig.suptitle('Original Data (NPS 17-20/05/2021 Zola) ', fontsize=10, color='1', y='1')

#plt.title('Rasters of Original Data (18/03/2021 Zola) ')
plt.show() #original data

fig, axes=rasters(shift_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Shift Model (NPS 17-20/05/2021 Zola) ', fontsize=10, color='1', y='1')

#plt.title('Rasters after Shift Model (18/03/2021 Zola) ')
plt.show()

fig, axes= rasters(linear_aligned_data, subplots=(5, 8));
fig.suptitle(' Rasters after Linear Model (NPS 17-20/05/2021 Zola) ', fontsize=10, color='1', y='1')
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/noPitchShiftTarget'
file_name='alignedDataBlockweekmay172021ShiftModeltargetnPS'
...
file_name='alignedDataBlockweekmay172021LinearModeltargetnPS'
