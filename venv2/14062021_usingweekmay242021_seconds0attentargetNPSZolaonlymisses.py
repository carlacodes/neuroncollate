...
fig.suptitle('Original Data (misses 24-28/05/2021 Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(cropped_data2,sorted_array, subplots=(5, 8), style='white');
fig.suptitle('Original Data Reorganised (misses 24-28/05/2021 Zola) ', fontsize=10, color='0', y='1')

plt.show() #original data

fig, axes=rasters(shift_aligned_data, sorted_array, subplots=(5, 8),style='white');
fig.suptitle(' Rasters after Shift Model (misses 24-28/05/2021 Zola) ', fontsize=10, color='0', y='1')
...
fig.suptitle(' Rasters after Linear Model (misses 24-28/05/2021 Zola) ', fontsize=10, color='0', y='1')
...
file_name='alignedDataBlockweekmay242021ShiftModellickreleasemisses'
...
file_name='alignedDataBlockweekmay242021LinearModellickreleasemisses'
