...
data_dir='D:\Electrophysiological Data\F1702_Zola_Nellie\HP_BlockNellie-68'
mat_fname = pjoin(data_dir, 'cleanedmatBlockNellie-68BB2andBB3April-26-2021.h5')

#import scipy.optimize.nnls
#matplotlib inline
mat_contents =  h5py.File(mat_fname)
data1 = mat_contents.get('HP_BlockNellie-683').value
data2=data1.transpose()

data2 = data2[..., np.newaxis]
list(mat_contents.keys())
struArray = mat_contents['HP_BlockNellie-683']
