...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/comdistWhenA/pitchshift'
...
file_name='alignedDataBlockweekmay242021ShiftModeldistractorWhenAPS'
...
file_name='alignedDataBlockweekmay242021LinearModeldistractorWhenAPS'
