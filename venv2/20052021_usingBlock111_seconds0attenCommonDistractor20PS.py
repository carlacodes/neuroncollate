...
import h5py
import numpy as np
filepath = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/commondistractor20/PitchShift/spikeArraysBlockNellie-111BB2andBB3curratten0dist20May-20-2021-11-34-01-649-AM.mat'
arrays = {}
...
file_name='alignedDataBlock111ShiftModeldistractor20PS'
...
file_name='alignedDataBlock111LinearModeldistractor20PS'
np.save(os.path.join(BASE_PATH, file_name), shift_aligned_data["spiketimes"])
