...
import h5py
import numpy as np
filepath = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/commondistractor20/spikeArraysBlockNellie-111BB2andBB3curratten0dist20May-20-2021-11-06-34-252-AM.mat'
arrays = {}
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-111/commondistractor20/'
file_name='alignedDataBlock111ShiftModeldistractor20'
...
file_name='alignedDataBlock111LinearModeldistractor20'
np.save(os.path.join(BASE_PATH, file_name), shift_aligned_data["spiketimes"])
np.save(os.path.join(BASE_PATH, 'linearModelneuronIDs'), shift_aligned_data["neurons"])
np.save(os.path.join(BASE_PATH, 'linearModeltrialIDs'), shift_aligned_data["trials"])
