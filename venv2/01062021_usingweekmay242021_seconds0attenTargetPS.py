...
for i in blocksOfInterest:
    user_input = 'D:/Electrophysiological Data/F1702_Zola_Nellie/HP_BlockNellie-'+str(i)+'/pitchshiftTarget'
...
plt.show();
BASE_PATH='D:/Electrophysiological Data/F1702_Zola_Nellie/dynamictimewarping/PitchShiftTarget'
file_name='alignedDataBlockweekmay242021ShiftModeltargetPS'
...
file_name='alignedDataBlockweekmay242021LinearModeltargetPS'
